 ...
 * 类名：VditorThemeCatalog
 * 类描述：维护 Vditor 内容主题与代码主题目录数据。
 * 创建人：@author Rain_润
 */
public final class VditorThemeCatalog {
    private static final Set<String> CONTENT_THEMES = parseThemes("""
            ant-design
            dark
            light
            wechat
    ...
    private static final Set<String> CODE_THEMES = parseThemes("""
            a11y-dark
            a11y-light
            agate
            androidstudio
    ...
    * 获取内容主题集合。
    */
    public static Set<String> getContentThemes() {
    ...
    * 获取代码主题集合。
    */
    public static Set<String> getCodeThemes() {
        return CODE_THEMES;
    }
    ...
    */
    private static Set<String> parseThemes(String rawThemes) {
        ...
        Arrays.stream(rawThemes.strip().split("\\R"))
                .map(String::trim)
